...
function BottomNav() {
  return (
    <div className="w-[375px] h-[80px] bg-white fixed bottom-0 left-1/2 -translate-x-1/2 flex justify-between px-[10px] items-start pt-[6px] pb-[34px] shadow-[0_-0.5px_0_0_rgba(0,0,0,0.05)] z-50" data-ai-alt="底部导航">
       <div className="w-[75px] flex flex-col items-center justify-center relative -top-1" data-ai-alt="首页项">
       ...
       <div className="w-[75px] flex flex-col items-center gap-[4px]" data-ai-alt="逛项">
       ...
       <div className="w-[75px] flex flex-col items-center gap-[4px]" data-ai-alt="消息项">
       ...
       <div className="w-[75px] flex flex-col items-center gap-[4px]" data-ai-alt="购物车项">
       ...
       <div className="w-[75px] flex flex-col items-center gap-[4px]" data-ai-alt="我的项">
